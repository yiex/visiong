...
elseif(DEFINED CMAKE_CXX_COMPILER AND CMAKE_CXX_COMPILER MATCHES "/bin/arm-rockchip830-linux-uclibcgnueabihf-g\\+\\+$")
    get_filename_component(TC_PATH "${CMAKE_CXX_COMPILER}/../.." ABSOLUTE)
elseif(DEFINED CMAKE_C_COMPILER AND CMAKE_C_COMPILER MATCHES "/bin/arm-rockchip830-linux-uclibcgnueabihf-gcc$")
    get_filename_component(TC_PATH "${CMAKE_C_COMPILER}/../.." ABSOLUTE)
else()
    set(TC_PATH "${PROJECT_ROOT}/toolchain/arm-rockchip830-linux-uclibcgnueabihf")
endif()

set(VISIONG_TOOLCHAIN_ROOT "${TC_PATH}" CACHE PATH "RV1106 cross toolchain root" FORCE)
