...
EXPECTED_PRESENT = [
    ...
    ROOT / "3rdparty/apriltag/LICENSE",
    ...
    ROOT / "include/visiong/modules/MppEncoderManager.h",
    ROOT / "include/visiong/modules/MppRecorder.h",
    ROOT / "src/modules/internal/mpp_utils.h",
    ROOT / "src/modules/internal/mpp_encoder_backend.h",
    ROOT / "src/modules/internal/mpp_encoder_backend.cpp",
    ...
    ROOT / "3rdparty/apriltag/CMakeLists.txt",
    ROOT / "3rdparty/apriltag/apriltag.c",
    ROOT / "3rdparty/apriltag/tag36h11.c",
...
EXPECTED_ABSENT = [
    ...
    ROOT / "include/visiong/modules/mpp_utils.h",
